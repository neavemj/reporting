...
Table_1_dataset <- matrix(c(SAN, H_type, Cleavage_site), ncol = 3)
colnames(Table_1_dataset) <- c("ACDP (AAHL) Sample No.", "HA type", "HA cleavage site sequence")
...
tree_text <- try(
  read.delim(tree, header = FALSE), silent = TRUE)

if(class(tree_text) != "try-error"){
